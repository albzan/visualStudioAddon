...
class AppModule(appModuleHandler.AppModule):
	...
	def chooseNVDAObjectOverlayClasses(self, obj, clsList):
		...
		# Added to support VS2017
		elif obj.name == "Quick Info" and obj.role == controlTypes.ROLE_TOOLTIP:
			clsList.insert(0, QuickInfoToolTip)
...
#will be removed when NVDA resolve status bar issues
	...
	def script_moveNavToToolTip(self, gesture):
		# get the parameter info object
		try:
			obj = api.getForegroundObject().firstChild.firstChild
		except:
	...
	__gestures = {
		...
		"kb:NVDA+shift+i": "moveNavToToolTip"
	}
...
class TextEditor(UIATextEditor.TextEditor):
	"""VS text editor view 
